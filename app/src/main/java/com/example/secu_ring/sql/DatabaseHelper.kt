package com.example.secu_ring.sql
...
import java.util.*
import com.example.secu_ring.activities.UsersMainPage
import kotlinx.android.synthetic.main.activity_users_main_page.view.*

class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    private lateinit var deleting: AppCompatButton
